...
if(isset($_POST["limit"], $_POST["start"]))
{
  ...
  $query = "SELECT * FROM microposts WHERE legend like :tag
      ...
      if($total_row > 0){
        ...
        foreach ($result as $row)
           ...
           ";
            ...
            $owner = find_user_by_id($row->user_id);
        if($comment->profilepic != null && $comment->comment != null){
            ...
            elseif($row->type == "quotes")
            {
             ...
             $media = '<div class="text-center">
                         <h3 style = "font-family:georgia,garamond,serif;font-size:26px;font-style:italic; color:#282923;"><i class="fas fa-quote-left"></i> '.'<p>'.convertHashtags(nl2br(replace_links($row->legend))).'</p>'.' <i class="fas fa-quote-right"></i></h3>
                        </div>
            ...
            elseif($row->type == "shared_post") {
              ...
              $legend = '<p>'.convertHashtags(nl2br(replace_links($row->legend))).'</p>';
              $media = '<video controls preload="meta-data" loop poster="">
                        <source src="/'.$row->urlMedia.'">
                        </source>
                     </video>';
              ...
              <div class="card my-3" id="'.$row->id.'">
                                  <div class="card-header border-0 py-2">
                                      <div class="d-flex justify-content-between">
                                          <div class="d-flex justify-content-between">
                                            <a href="#">
                                        <img class="rounded-circle" src="/'. e($owner->profilepic) .'" style="height: 40px; width: 40px; border:1.5px solid #f5f6fa;" alt="" />
                                    </a>
                                    <div class="ml-3">
                                        <div class="h6 m-0">
                                            <a href="profile.php?id='.e($owner->user_id).'" style="font-style: italic;">'. e($owner->name).' '.e($owner->nom2).'</a>
                                            '.$type.'
                                        </div>
              ...
              '.$shareModal.'
                 <div class="card my-3" id="'.$row->id.'">
                                  <div class="card-header border-0 py-2">
                                    ...
                                    <div class="ml-3">
                                        <div class="h6 m-0">
                                            <a href="profile.php?id='.e($row->user_id).'" style="font-style: italic;">'. e($owner->name).' '.e($owner->nom2).'</a>
                                            '.$type.'
                                        </div>
                                        <div class="text-muted h8" style="word-break: break-all; font-style: italic;"><span class="timeago" title="'. $row->created_at .'">'.zungvi_time_ago($row->created_at).'</span><i class="fa fa-globe" aria-hidden="true"></i></div>
                                    </div>
              ...
              '.$likeModal.'
                 <div class="card my-3" id="'.$row->id.'">
                                  <div class="card-header border-0 py-2">
                                    ...
                                    <div class="ml-3">
                                        <div class="h6 m-0">
                                            <a href="profile.php?id='.e($row->user_id).'" >'. e($owner->name).' '.e($owner->nom2).'</a>
                                            '.$type.'
                                        </div>
