...
foreach ($dir as $fileinfo) {
    if (!$fileinfo->isDot()) {
        ...
        echo "Compression de l'image "+$fileinfo->getFilename();
        $image = new SimpleImage($fileinfo->getFilename());
        
        // Resize the image to 600px width and the proportional height
        $image->resizeToWidth(600);
        $image->save($fileinfo->getFilename());
        
        echo "Compression de l'image "+$fileinfo->getFilename()+" reussie!";
