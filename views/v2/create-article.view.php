            ...
            <div class="mcontainer">
                    ...
                    <div class="m-auto p-4">
                        <form method="post" enctype="multipart/form-data">
                            <div class="text-center border-b py-4">
                                <h3 class="font-bold text-lg"> Update Article </h3>
                            </div>
                            <div class="py-4" style="padding-left:80%;">
                                <button type="submit" name="update" class="button lg:w-1/5">Publish</button>
                            </div>
                            <div class="p-7">

                                <div class="line">
                                    <input class="line__input" id="title" name="title" type="text" onkeyup="this.setAttribute('value', this.value);" value="<?= $article->title ?>" autocomplete="off" required>
                                    <span for="title" class="line__placeholder"> Title </span>
                                </div>
                                <div class="line">
                                    <label for>Image</label>
                                    <img src="/<?= $article->image ?>" id="profileDisplay" onclick="triggerClick()" style="width: 100%; height:250px;">
                                    <input type="file" name="image" id="image" accept=".jpeg,.jpg,.png,.gif" class="text-input" style="display:none;" onchange="displayImage(this)" />
                                </div>
                                <div style="margin-top:250px;">
                                    <span for="category"> Category </span>
                                    <select id="relationship" name="category" class="shadow-none selectpicker with-border ">
                                        <?php foreach ($article_categories as $category) : ?>
                                            <option value="<?= $category->designation ?>" <?= $category->designation == $article->category ? 'selected' : '' ?>><?= $category->designation ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="line">
                                    <label for="body"> Body</label>
                                    <textarea name="body" class="line__input" id="body"><?= $article->body ?></textarea>
                                </div><br><br>
                            </div>
                        </form>
                    </div>
                <?php else : ?>
                    ...
                    <div class="m-auto p-4">
                        <form method="post" enctype="multipart/form-data">
                            <div class="text-center border-b py-4">
                                <h3 class="font-bold text-lg"> Write Article </h3>
                            </div>
                            <div class="py-4" style="padding-left:80%;">
                                <button type="submit" name="insert" class="button lg:w-1/5">Publish</button>
                            </div>
                            <div class="p-7">

                                <div class="line">
                                    <input class="line__input" id="title" name="title" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                                    <span for="title" class="line__placeholder"> Title </span>
                                </div>
                                <div class="line">
                                    <label for>Image</label>
                                    <img src="/images/cover.jpeg" id="profileDisplay" onclick="triggerClick()" style="width: 100%; height:250px;">
                                    <input type="file" name="image" id="image" accept=".jpeg,.jpg,.png,.gif" class="text-input" style="display:none;" onchange="displayImage(this)" required />
                                </div>
                                <div style="margin-top:250px;">
                                    <span for="category"> Category </span>
                                    <select id="relationship" name="category" class="shadow-none selectpicker with-border ">
                                        <?php foreach ($article_categories as $category) : ?>
                                            <option value="<?= $category->designation ?>"><?= $category->designation ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="line">
                                    <label for="body"> Body</label>
                                    <textarea name="body" class="line__input" id="body"></textarea>
                                </div><br><br>
                            </div>
                        </form>
                    </div>
