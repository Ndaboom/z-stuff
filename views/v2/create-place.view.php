            ...
            <div class="mcontainer">
                ...
                <div class="breadcrumb-area py-0">
                    <div class="breadcrumb">
                        <ul class="m-0">
                            <li>
                                <a href="events.php?p=all_events">Places</a>
                            </li>
                            <li class="active">
                ...
                <form method="post">
                    ...
                    <div class="text-center border-b py-4">
                        <h3 class="font-bold text-lg"> Create New Place </h3>
                    </div>
                    ...
                    <div class="p-7 space-y-5">
                        ...
                        <div class="line">
                            <input class="line__input" id="place_name" name="place_name" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                            <span for="place_name" class="line__placeholder"> Page name </span>
                        </div>
                        <div class="line h-32"> 
                            ...
                            <span for="description" class="line__placeholder"> Page description </span> 
                        </div> 
                    ...
                    <div class="border-t flex justify-center border-gray-100 p-6">
                        <button type="submit" name="insert-place" class="button lg:w-1/3">
                            Create
                        </button>
                    </div>
                </form>
