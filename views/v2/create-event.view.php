            ...
            <div class="mcontainer">
                ...
                <div class="breadcrumb-area py-0">
                    <div class="breadcrumb">
                        <ul class="m-0">
                            <li>
                                <a href="events.php?p=all_events">Events</a>
                            </li>
                            <li class="active">
                ...
                <form method="post">
                    ...
                    <div class="p-7 space-y-5">
                        ...
                        <div class="line">
                            <input class="line__input" id="event_name" name="event_name" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                            <span for="event_name" class="line__placeholder"> Event name </span>
                        </div>
                        <div class="line">
                            <input class="line__input" id="organization" name="organization" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                            <span for="organization" class="line__placeholder"> Organization </span>
                        </div>
                        <div class="line h-32"> 
                            <textarea class="line__input h-32"  id="description" name="description" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required></textarea>
                            <span for="description" class="line__placeholder"> Event description </span> 
                        </div>
                        <div class="grid grid-cols-2 gap-3 lg">
                        <div class="line">
                            <input class="line__input" id="city" name="city" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                            <span for="city" class="line__placeholder"> City </span>
                        </div>
                        <div class="line">
                            <input class="line__input" id="country" name="country" type="text" onkeyup="this.setAttribute('value', this.value);" value="" autocomplete="off" required>
                            <span for="country" class="line__placeholder"> Country </span>
                        </div>
                       </div> 
                       <div class="grid grid-cols-2 gap-3 lg">
                        <div>
                            <label for="start_date"> Start date</label>
                            <input type="date" name="start_date" id="start_date" placeholder="Start date" class="shadow-none with-border" required>
                        </div>
                        <div>
                    ...
                    <div class="border-t flex justify-center border-gray-100 p-6">
                        <button type="submit" name="insert" class="button lg:w-1/3">
                            Create
                        </button>
                    </div>
                </form>
            ...
            <div class="flex flex-1 items-start space-x-4 p-5">
                ...
                <div class="flex-1 pt-2">
                    <textarea class="uk-textare text-black shadow-none focus:shadow-none text-xl font-medium resize-none" rows="5"
                        placeholder="What's Your Mind ? <?= $user->name ?>!"></textarea>
                </div>
