            ...
            <div class="mcontainer">
                ...
                <div class="max-w-2xl m-auto shadow-md rounded-md bg-white lg:mt-20">  
                    ...
                    <div class="text-center border-b border-gray-100 py-6">
                        <h3 class="font-bold text-xl"> Add stream details</h3>
                        <?php include('partials/_error.php');?>
                    </div>
                    <form method="post" enctype="multipart/form-data">
                    <!-- form body -->
                    <div class="p-10 space-y-7" style="height: 250px;">

                    <div class="line">
                        <label for>Stream cover</label>
                    ...
                    <!-- form footer -->
                    <div class="border-t flex justify-between lg:space-x-10 p-7 bg-gray-50 rounded-b-md" style="margin-top: 90px;">
                        <p class="text-sm leading-6"> One last detail and it's over! </p>
                        <button type="submit" name="insert-config" class="button lg:w-1/2">
                           Get Started!
                        </button>
                    </div> 
                    </form>
