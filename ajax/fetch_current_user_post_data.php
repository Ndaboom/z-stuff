...
require '../includes/functions.php';
        ...
        if($data->urlMedia !=null && $data->type != "sound")
               	{
                     $media='<img class="img-thumbnail img-responsive" src="'.$data->urlMedia.'" alt="Card image cap">';                        
               	}
        ...
        else
        {
         ...
         if(get_session('user_id') == $data->user_id){
                    $modal='<div class="modal fade" id="monModal'.$data->id.'">
            
                         <div class="modal-dialog" >
                
                               <div class="modal-content">
                                   <div class="modal-body text-center" style="background-color: #e9ebee;">
                                  <a href="delete_micropost.php?id='. $data->id .'" ><div class="alert text-danger"><i class="far fa-trash-alt"></i> Delete</div></a>
                                  </div>     
                                 </div>
                              </div>
                </div>';
                   ...
                   <div class="card my-3">
                                    ...
                                    <div class="dropdown" style="font-style: italic;">
                                        <button class="btn btn-link dropdown-toggle" type="button" id="dropdownMenuButton"
                                            data-toggle="modal" data-target="#monModal'.$data->id.'" aria-haspopup="true" aria-expanded="false"></button>
