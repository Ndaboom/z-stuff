...
if(isset($_POST["post_id"]))
  {
    ...
    $q=$db->prepare('SELECT * FROM placeposts WHERE id=?');
                    ...
                    if($statement->execute())
                    {
                     ...
                     if(count($comments) != 0){
                        ...
                        if($comment->user_id == get_session('user_id')){
                         $delete_btn = '<a href="" class="text-red-600 delete_comment" id="dcomment'.$comment->id.'" data-poster_id="'.$comment->user_id.'" data-commentid="'.$comment->id.'"> <i class="uil-heart"></i> Delete </a>';   
                        }else{
                         $delete_btn = "";   
                        }
               ...
               <div class="modal fade" id="likesModal'.$row->id.'">
                ...
                ';
                  ...
                  if($_SESSION['user_id'] == $row->user_id){
                      $buttons = '
                        <li> 
                            <a href="" class="flex items-center px-3 py-2 text-red-500 hover:bg-red-100 hover:text-red-500 rounded-md dark:hover:bg-red-600 remove_friend">       
