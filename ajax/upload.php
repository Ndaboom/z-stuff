...
if(isset($_FILES['files']))
{
	...
	$insert_query = "
	INSERT INTO event_posts_table
	(user_id, event_id, post_content, post_code, post_datetime, post_status, post_type) 
	VALUES (:user_id, :event_id, :post_content, :post_code, :post_datetime, :post_status, :post_type)
	";
